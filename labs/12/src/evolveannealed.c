...
#define DEFAULT_INPUT  "labs/12/data/annealed_couplings.dat"
#define DEFAULT_OUTPUT "labs/12/data/annealed_evolution.txt"
...
int main(int argc, char **argv)
{
    ...
    printf("Animate with:\n");
    printf("  python3 labs/12/scripts/animatedwavehex.py %s --tmax %.12f "
           "--save docs/assets/annealed-honeycomb.gif\n",
